...
import com.test.taqtile.takitiletest.R.id.*
...
class UserListActivity : AppCompatActivity() {
  ...
  private var listRequest =  ArrayList<LoginResponse.Data.User>()
  private var listUsers = ArrayList<LoginResponse.Data.User>()
  private var page = 0
...
//          getUsersListRequest(jsonParams, "")
  ...
  inner class UsersAdapter : BaseAdapter {
    private var usersList = ArrayList<LoginResponse.Data.User>()
    private var context: Context? = null

    constructor(context: Context, usersList: ArrayList<LoginResponse.Data.User>) : super() {
