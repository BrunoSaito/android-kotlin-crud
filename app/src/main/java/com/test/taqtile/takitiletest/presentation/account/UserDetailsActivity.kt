...
//
//    userDetails.enqueue(object : Callback<UserDetailsActivity?> {
//      override fun onResponse(call: Call<UserDetailsActivity?>, response: Response<UserDetailsActivity?>) {
...
//      }
//
//      override fun onFailure(call: Call<UserDetailsActivity?>, failureResponse: Throwable) {
//        progressBarDetailsUser.visibility = ProgressBar.GONE
//      }
//    })
//  }
